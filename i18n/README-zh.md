...
<h1>OMNI</h1>
<p align="center">
    <em><b>你的智能体为已经看过的输出付了两次钱。</b>OMNI 改为交还一个可取回的句柄：读两遍的文件省 <b>97.2%</b>。放到整场会话上，它取走你的工作里实际存在的重复中的约四分之一，在下面那份语料上相当于文件读取字节的 <b>4.5%</b>。你的工作重复得多不多，决定你落在这两个数字之间的哪一处。什么都不删除，什么都不编造，这里每个数字都能在你自己的历史上重放。</em>
</p>
...
* **这份语料不会过期。** 它冻结在磁盘上，哈希写在 `docs/benchmarks/0.7.7.json` 里，
