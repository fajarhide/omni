...
<h1>OMNI</h1>
<p align="center">
    <em><b>에이전트는 이미 본 출력에 두 번 값을 치릅니다.</b> OMNI는 대신 다시 꺼낼 수 있는 핸들을 돌려줍니다. 두 번 읽는 파일에서 <b>97.2%</b>. 세션 전체로 보면 당신의 작업에 실제로 들어 있는 반복 가운데 약 4분의 1을 걷어내며, 아래 코퍼스에서는 파일 읽기 바이트의 <b>4.5%</b>에 해당합니다. 당신의 작업이 얼마나 반복되는지가 그 둘 사이 어디에 놓일지를 정합니다. 아무것도 삭제하지 않고, 아무것도 지어내지 않으며, 여기의 모든 숫자는 당신의 기록에서 그대로 재현됩니다.</em>
</p>
...
* **이 코퍼스는 만료되지 않습니다.** 디스크에 동결되어 있고 해시는
  `docs/benchmarks/0.7.7.json`에 있으므로, 지난 7일에 무엇이 남아 있었는지가 아니라
