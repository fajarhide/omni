...
<h1>OMNI</h1>
<p align="center">
    <em><b>같은 출력을 다시 읽는 데 돈을 쓰지 마세요.</b> OMNI는 반복되는 바이트를 다시 꺼낼 수 있는 핸들로 바꿉니다. 에이전트가 두 번 읽는 파일에서 97.2%, 실제 명령 5,984건에서 바쁜 한 주는 69.6%, 평범한 한 주는 14.9%. 아무것도 삭제하지 않고, 아무것도 지어내지 않으며, 모든 수치는 여러분의 코퍼스에서 그대로 재현됩니다.</em>
</p>
