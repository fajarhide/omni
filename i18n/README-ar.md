...
| **الأرقام مقيسة لا مأمولة** | ‏5,984 تتبّعًا حقيقيًا أُعيد تشغيلها على الملف التنفيذي للإصدار، و‏96.1٪ من الاستدعاءات لم توفّر شيئًا، وهو رقم ننشره أيضًا | [`القياسات`](#القياسات) |
...
* **‏96.1٪ من الاستدعاءات لم توفّر شيئًا**، وننشر ذلك لأنه الرقم الذي يخبرك بقيمة الباقي.
