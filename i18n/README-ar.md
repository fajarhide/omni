...
<p align="center" dir="rtl">
    <em><b>توقّف عن الدفع لإعادة قراءة المخرجات نفسها.</b> يحوّل OMNI البايتات المكرّرة إلى مقابض قابلة للاسترجاع: %97.2 على ملف يقرأه وكيلك مرتين، وعبر 5,984 أمرًا حقيقيًا %69.6 في أسبوع ثقيل و%14.9 في أسبوع عادي. لا حذف، ولا اختلاق، وكل رقم يُعاد تشغيله على مجموعتك أنت.</em>
</p>
...
* **‏كل رقم أعلاه هو بايتات لكل أمر، وهذا ليس فاتورتك.** ترتبط رموز الإدخال المحاسَبة تقريبًا بعدد الأدوار مضروبًا في حجم البادئة، لذا فإن تقصير الحمولة لا يوفّر إلا حين يُسقط دورًا أيضًا. وبالقياس الشامل على الجلسات الكاملة يكون التوفير في المتوسط أكبر مما في هذا الجدول، وهو غير مضمون في أي جلسة بعينها، بما في ذلك تشغيلات لم تنخفض فيها الفاتورة إطلاقًا.
