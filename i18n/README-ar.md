...
تُقرأ المرشحات من مجلد المنزل فقط. ويُتجاهل مجلد `.omni/signals/` داخل أي مستودع عن قصد: يمكن للمرشح أن يخفي أسطرًا، لذا فإن مرشحًا يصل مع نسخة من المستودع قد يغيّر بهدوء ما يراه وكيل الزائر.
