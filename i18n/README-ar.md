...
* **‏1.4٪** من المرشّحات، و**‏5.1٪** مع السجلّ، وقد أخذ السجلّ **‏24.1٪ من كل
...
* **هذه المجموعة لا تنتهي صلاحيّتها.** إنها مجمّدة على القرص وبصمتها في
  `docs/benchmarks/0.7.7.json`، فيمكن التحقّق من الأرقام أعلاه على البايتات نفسها في
