...
<p align="center" dir="rtl">
    <em><b>توقّف عن الدفع لإعادة قراءة المخرجات نفسها.</b> يحوّل OMNI البايتات المكرّرة إلى مقابض قابلة للاسترجاع: %97.2 على ملف يقرأه وكيلك مرتين، و%14.9 عبر 6,656 أمرًا حقيقيًا. لا حذف، ولا اختلاق، وكل رقم يُعاد تشغيله على مجموعتك أنت.</em>
</p>
...
| **الأرقام مقيسة لا مأمولة** | ‏6,656 تتبّعًا حقيقيًا أُعيد تشغيلها على الملف التنفيذي للإصدار، و‏97.3٪ من الاستدعاءات لم توفّر شيئًا، وهو رقم ننشره أيضًا | [`القياسات`](#القياسات) |
...
مقيسًا على الملف التنفيذي للإصدار بإعادة تشغيل **‏6,656 تنفيذًا حقيقيًا للأوامر**
تغطي **‏2026-08-04 إلى 08-10 بتوقيت UTC**، وكلها مخرجات وصلت إلى نموذج. النافذة
الزمنية جزء من الرقم: تُقلَّم `execution_traces` بعد سبعة أيام، فتختفي المجموعة بعد
أسبوع من قياسها.

* مخرجات البناء والاختبار **‏87.8٪**. وأكبر فئة هي إعادة قراءة الملفات: تأخذ المرشّحات
  **‏0.0٪** ويأخذ السجلّ **‏24.7٪**، وهذه الفجوة نفسها سبب وجود السجلّ.
* **‏97.3٪ من الاستدعاءات لم توفّر شيئًا**، وننشر ذلك لأنه الرقم الذي يخبرك بقيمة الباقي.
