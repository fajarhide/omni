...
<h1>OMNI</h1>
<p align="center">
    <em><b>エージェントは一度見た出力に二度払っています。</b>OMNI は代わりに取り出し可能なハンドルを返します。二度読むファイルで <b>97.2%</b>。セッション全体では、あなたの作業に実際に含まれる繰り返しのおよそ四分の一を回収し、下のコーパスではファイル読み取りバイトの <b>4.5%</b> にあたります。あなたの作業がどれだけ繰り返すかが、この二つのどこに着地するかを決めます。何も削除せず、何も捏造せず、ここのどの数字もあなた自身の履歴で再現できます。</em>
</p>
...
* **このコーパスは期限切れになりません。** ディスク上で凍結され、ハッシュは
  `docs/benchmarks/0.7.7.json` にあります。直近7日に何が残っていたかではなく、次の
