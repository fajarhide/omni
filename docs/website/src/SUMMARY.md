...
- [What it refuses to touch](concepts/format-safety.md)
- [What it costs](concepts/what-it-costs.md)

# Using it

- [Install](use/install.md)
- [Your first hour](use/first-hour.md)
- [Reading the markers](use/markers.md)
- [Seeing what it saved](use/seeing-savings.md)
- [Memory across sessions](use/memory.md)
- [When something looks wrong](use/troubleshooting.md)
