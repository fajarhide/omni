...
4.9%, over the same filters and the same blocks, so that gap is the dedup engine on
its own. Our filter tier is the weakest of the four at 1.4%, which is why our own
